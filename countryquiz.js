...
const countries = [
  ...
  { name: "central african republic",         iso: "cf", alt: ["car", "centrafrique", "république centrafricaine", "ködörösêse tî bêafrîka"] },
